...
const faveSnack = "nachos"; "quesadillas"; "cheese fries";
...
const faveDrink = "hot tea"; "sprite"; "mango-lemonade";
...
const total = netFlix + peacock + hulu + disneyPlus + youTubePremium;
console.log(total)
...
const newTotal = netFlix + hulu + peacock + youTubePremium + disneyPlus
...
/*
    ...
    them both to be all the subscriptions variables
...
// CODE HERE
const savings = ((total - newTotal) / total) * 100
console.log(savings)
